...
<?php $__env->startSection('container'); ?>
    ...
    <div class="row">
                ...
                <div class="widget-body">
                    <div class="widget-main" style="overflow: auto">
                        ...
                        <div class="col-md-3">
                            ...
                            <?php else: ?>
                                <input name="store_name" disabled class="form-control text-center" id="form-field-8" placeholder="المخزن التابع له">
                            <?php endif; ?>
                        </div>
                        
                        <div class="col-md-2">
                            <label for="form-field-8">كود الصنف</label>
                            <input data-url="<?php echo e(url('treasury-bonds/dismissal/json')); ?>" type="text" class="form-control text-center" id="item-code" placeholder="00" >
                        ...
                        <div class="col-md-3" style="overflow:hidden;position:unset">
                            ...
                            <input data-url="<?php echo e(url('treasury-bonds/dismissal/item')); ?>" autocomplete="off" class="form-control " id="item-name" placeholder="أكتب اسم الصنف هنا ان لم تتذكر كود الصنف">
        ...
        <div class="col-xs-12">
            <form id="bill-form" action="<?php echo e(url('treasury-bonds/dismissal/save')); ?>" method="POST">
