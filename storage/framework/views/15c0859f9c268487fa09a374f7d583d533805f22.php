            ...
            <table id="simple-table" class="table  table-bordered table-hover">
                ...
                <?php if(isset($items)): ?>
                    ...
                    <tr>
                        ...
                        <td class="hidden-480"><?php echo e($item->category->name); ?></td>
                        <td><?php echo e($item->unity->name); ?></td>

                        <td class="hidden-480">
                            <span class="label label-sm label-warning"><?php echo e($item->minimum); ?></span>
                        </td>
