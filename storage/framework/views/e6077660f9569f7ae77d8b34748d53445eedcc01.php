				...
				<div class="navbar-buttons navbar-header pull-left" role="navigation">
					<ul class="nav ace-nav">
										...
										<li>
											<a href="#">
												<div class="clearfix">
													...
													<span class="pull-left badge badge-info">+11</span>
												</div>
											</a>
										</li>
									</ul>
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle"> <!-- .$user->image -->
								<img style="width:36px;height:36px;object-fit:cover;" class="nav-user-photo" src="<?php echo e(asset('/avatars/'.$user->image)); ?>" alt="<?php echo e((isset($user->name)) ? $user->name : 'Gest'); ?>" />
								<span class="user-info">
									<small>مرحباً,</small>
									<?php echo e((isset($user->name)) ? $user->name : 'Gest'); ?>
