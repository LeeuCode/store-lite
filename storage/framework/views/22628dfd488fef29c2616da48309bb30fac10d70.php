...
<?php $__env->startSection('container'); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <form action="<?php echo e(url('companies')); ?>" method="post" class="form-horizontalz" role="form">
            ...
            <table id="simple-table" class="table  table-bordered table-hover">
                ...
                <?php if(isset($companies)): ?>
                    ...
                    <tr>
                        ...
                        <td class="hidden-480">
                            <p class="text-center" ><?php echo e(\date('d-m-Y', strtotime($company->created_at))); ?></p>
                        </td>
                        <td class="hidden-480">
                            <p>أحمد محمد</p>
                        </td>
                        <td class="hidden-480">
                            <?php if($company->state == 1): ?>
                        ...
                        <td>
                            ...
                            <a href="<?php echo e(url('companies/'.$company->id.'/edit')); ?>" class="btn btn-xs btn-info">
