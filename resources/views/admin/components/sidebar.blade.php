...
<div class="main-container ace-save-state" id="main-container">
        ...
        <div id="sidebar" class="sidebar responsive ace-save-state">
            ...
            <ul class="nav nav-list">
                ...
                <li {!! Request::path() == 'items/create' ? 'class="active"' : '' !!} >
                ...
                <li {!! Request::path() == 'companies' ? 'class="active"' : '' !!} >
                ...
                <li {!! Request::path() == 'categories' ? 'class="active"' : '' !!} >
                ...
                <li {!! Request::path() == 'unities' ? 'class="active"' : '' !!} >
                    <a href="{{ url('unities') }}" >
                ...
                <li {!! Request::path() == 'store/create' ? 'class="active"' : '' !!} >
                ...
                @if( storeAllow('reception') )
                <li {!! Request::path() == 'stores' ? 'class="active"' : '' !!} >
                    <a href="{{ url('stores') }}" >
                ...
                @if( storeAllow('reception') )
                <li {!! Request::path() == 'treasury-bonds/reception/create' ? 'class="active"' : '' !!} >
                ...
                <li {!! Request::path() == 'treasury-bonds/dismissal/create' ? 'class="active"' : '' !!} >
                ...
                <li {!! Request::path() == 'treasury-bonds/reactionary/create' ? 'class="active"' : '' !!} >
