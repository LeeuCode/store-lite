					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue dropdown-modal">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle"> <!-- .$user->image -->
								<img style="width:36px;height:36px;object-fit:cover;" class="nav-user-photo" src="{{ asset('/avatars/'.$user->image) }}" alt="{{ (isset($user->name)) ? $user->name : 'Gest' }}" />
								<span class="user-info">
									<small>مرحباً,</small>
									{{ (isset($user->name)) ? $user->name : 'Gest' }}
								</span>
