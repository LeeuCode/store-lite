...
@section('container')
    ...
    <div class="row">
                ...
                <div class="widget-body">
                    <div class="widget-main" style="overflow: auto">
                        ...
                        <div class="col-md-2">
                            ...
                            <input data-url="{{ url('treasury-bonds/reactionary/json') }}" type="text" class="form-control text-center" id="item-code" placeholder="00" autofocus>
                        ...
                        <div class="col-md-3" style="overflow:hidden;position:unset">
                            ...
                            <input data-url="{{ url('treasury-bonds/reactionary/item') }}" autocomplete="off" class="form-control " id="item-name" placeholder="أكتب اسم الصنف هنا ان لم تتذكر كود الصنف">
        ...
        <div class="col-xs-12">
            <form id="bill-form" action="{{ url('treasury-bonds/reactionary/save') }}" method="POST">
                {{ csrf_field() }}
