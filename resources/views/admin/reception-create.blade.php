...
@section('container')
    ...
    <div class="row">
                ...
                <div class="widget-body">
                    <div class="widget-main" style="overflow: auto">
                        <div class="col-md-3">
                            ...
                            <select id="store-name" class="form-control chosen-select" name="store_name" id="form-field-8">
                                @if( count($stores) != 1 )
                        ...
                        <div class="col-md-2">
                            ...
                            <input data-url="{{ url('treasury-bonds/reception/json') }}" type="text" class="form-control text-center" id="item-code" placeholder="00" autofocus>
                        ...
                        <div class="col-md-3" style="overflow:hidden;position:unset">
                            ...
                            <input data-url="{{ url('treasury-bonds/reception/item') }}" autocomplete="off" class="form-control " id="item-name" placeholder="أكتب اسم الصنف هنا ان لم تتذكر كود الصنف">
        ...
        <div class="col-xs-12">
            <form id="bill-form" action="{{ url('treasury-bonds/reception/save') }}" method="POST">
                {{ csrf_field() }}
...
@section('custom-script')
    ...
    jQuery(function($) {
        // select2Ajax('#store-name','{{url('/ajax/stores')}}');
        $('#store-name').select2({
            dir: "rtl",
        });
    });
