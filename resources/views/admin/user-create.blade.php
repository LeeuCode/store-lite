...
@section('container')
    ...
    <div class="row">
        <div class="col-xs-12">
            <form id="save-user" action="{{ url('user/save') }}" method="POST" class="form-horizontal" role="form" enctype="multipart/form-data" >
                ...
                <div class="tabbable">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="home" class="tab-pane fade in active">
                            @include('admin.permasions.users-public')
                        </div>
                        {{-- End Tab #Home --}}
                        ...
                        <div id="messages" class="tab-pane fade" style="overflow: hidden">
                            ...
                            @include('admin.permasions.public')

                            <h4 class="text-info blue" >صلاحيات المخازن</h4>
                            @include('admin.permasions.store')
